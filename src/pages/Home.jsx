...
import { FaDownload, FaGithub, FaLinkedin, FaTwitter, FaBolt, FaInstagram, FaArrowRight, FaBookOpen, FaCalendarAlt, FaClock } from 'react-icons/fa';
...
const Home = () => {
    ...
    const [featuredPosts] = React.useState(getFeaturedPosts(language).slice(0, 2));
    ...
    return (
        <div className="min-h-screen">
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                    ...
                    >
                        ...
                        <motion.h2
                            ...
                            className={`text-2xl md:text-3xl font-semibold mb-6 ${theme === 'dark'
                                ? 'text-cyan-300'
                                : 'text-purple-700'
                                }`}
                        >
            ...
            {featuredPosts.length > 0 && (
                <section className={`py-20 px-4 relative ${theme === 'dark'
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center justify-between mb-4">
                                                <span className={`px-4 py-2 rounded-full text-sm font-medium ${theme === 'dark'
                                            ...
                                            {/* Title */}
                                            <h3 className={`text-2xl font-bold mb-4 group-hover:text-cyan-400 transition-colors ${theme === 'dark' ? 'text-white' : 'text-gray-800'
                                                }`}>
                                                {title}
                                            </h3>

                                            {/* Excerpt */}
                                            <p className={`mb-6 text-base leading-relaxed ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                                                }`}>
                                                {excerpt || description}
                                            </p>

                                            {/* Meta Info */}
                                            <div className={`flex items-center gap-4 text-sm mb-6 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'
                                                }`}>
                                            ...
                                            {/* Read More */}
                                            <div className={`flex items-center gap-2 font-medium group-hover:gap-3 transition-all ${theme === 'dark' ? 'text-cyan-400' : 'text-purple-600'
                                                }`}>
