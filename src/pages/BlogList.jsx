      ...
      >
        ...
        >
          ...
          <h2
            ...
            } font-bold mb-3 group-hover:text-cyan-400 transition-colors ${
          ...
          {/* Read More */}
          <div
            className={`mt-4 flex items-center gap-2 font-medium group-hover:gap-3 transition-all ${
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className={`pl-10 pr-8 py-3 rounded-lg border appearance-none cursor-pointer transition-all duration-300 focus:outline-none focus:ring-2 ${
                    theme === "dark"
                      ? "bg-gray-800 border-gray-700 text-white focus:ring-cyan-400 focus:border-cyan-400"
                      : "bg-white border-gray-300 text-gray-900 focus:ring-purple-500 focus:border-purple-500"
                  }`}
