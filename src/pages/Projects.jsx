          ...
          {!loading && !error && projects.length > 0 && (
            <>
              {featuredProjects.length > 0 && (
                ...
                >
                  <h2
                    className={`text-4xl font-bold mb-8 text-center lightning-text ${
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {featuredProjects.map((project, index) => (
                      <motion.div
                        ...
                        transition={{
                          duration: 0.8,
                          delay: firstLanding ? 0.5 + index * 0.2 : 0,
                        }}
                        whileHover={{
                          scale: 1.02,
                          boxShadow:
                        ...
                        className={`project-card group p-8 rounded-xl border transition-all duration-300 ${
                          theme === "dark"
                        ...
                        <div className="flex items-start justify-between mb-6">
                          <div className="flex items-center gap-4">
                            ...
                            >
                              {project.language ? (
                                React.createElement(
                                  getTechInfo(project.language).icon,
                                  {
                                    className: "text-2xl",
                                    style: {
                                      color: getTechInfo(project.language)
                                        .color,
                                    },
                                  }
                                )
                            ...
                            {project.language ? (
                              React.createElement(
                                getTechInfo(project.language).icon,
                                {
                                  className: "text-lg",
                                  style: {
                                    color: getTechInfo(project.language).color,
                                  },
                                }
                              )
                            ) : (
