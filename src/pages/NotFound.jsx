        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate("/")}
              className={`px-8 py-4 rounded-lg font-semibold flex items-center gap-3 transition-all duration-300 ${
                theme === "dark"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate(-1)}
              className={`px-8 py-4 rounded-lg font-semibold border-2 transition-all duration-300 flex items-center gap-3 ${
                theme === "dark"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
              {text.links.map((link, index) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`p-3 rounded-lg bg-gradient-to-r ${link.color} w-fit mx-auto mb-4`}
                    >
